...
public class MainActivity extends FragmentActivity implements
   ...
   // private TextView mConnectionStatus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //  = (TextView) findViewById(R.id.lat_lng);
    ...
    public void getLocation() {
        ...
        if (servicesConnected()) {
            ...
            IntentMsg =LocationUtils.getLatLng(this, currentLocation);
        }
    }
    ...
    public void onConnected(Bundle bundle) {
        ...
        getLocation();
        Intent second =new Intent("com.example.locationupadate.SecondActivity");
		second.putExtra("key", IntentMsg);
    ...
    public void onLocationChanged(Location location) {
       ...
       // mConnectionStatus.setText(R.string.location_updated);
        ...
        IntentMsg =LocationUtils.getLatLng(this, location);
    }
